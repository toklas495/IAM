...
`
  ...
  "reset-pass": {
    sub: "Reset Your Password – OTP Valid for 15 Minutes",
    body: `<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8" />
          ...
          <tr>
            <td style="padding:30px; color:#333333;">
              ...
              <div style="text-align:center; margin:30px 0;">
                <a href="{{__LINK__}}"
                   style="background-color:#2563eb; color:#ffffff; text-decoration:none; padding:14px 28px; border-radius:6px; font-size:15px; display:inline-block;">
                  Reset Password
                </a>
              </div>

              <p style="font-size:14px; line-height:1.6;">
                ⏳ This link contains a one-time OTP and will expire in <strong>{{__EXPIRE__}}</strong>.
              </p>
              ...
              <p style="font-size:13px; color:#6b7280; line-height:1.6;">
                ...
                <a href="mailto:{{__SUPPORT__}}" style="color:#2563eb; text-decoration:none;">
                  {{__SUPPORT__}}
                </a>
              </p>
            </td>
